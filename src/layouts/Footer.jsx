    ...
    <footer className="bg-black text-gray-300 py-12 border-t border-gray-800">
      <div className="max-w-[1600px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-sm text-gray-400">Leading platform for searching and booking music Show tickets.</p>
        </div>
        <div>
          <h3 className="text-lg font-semibold text-white mb-4">Link</h3>
